...
namespace PT
{
    public partial class Funcionarios_Registar : Form
    {
        public Funcionarios_Registar()
        {
            InitializeComponent();
        }
        ...
        private void bunifuThinButton21_Click_1(object sender, EventArgs e)
        {
                ...
                if (j == 12)
            {
                ...
                if (erro == false)
                {
                    ...
                    try
                    {
                        Globais.verficacao = 0;
                      int x = BLL.Funcionarios.insertFuncionario(Instrutor_Nome.Text, Instrutor_CC.Text, maskedTextBox1.Text,Convert.ToInt32(Instrutor_NIF.Text), Convert.ToInt32(Instrutor_Telemovel.Text), Instrutor_Email.Text, Instrutor_Morada.Text, Instrutor_Cod_Postal.Text, datanasc, Instrutor_Certificacao.Text,comboBox1.Text, Instrutor_Senha.Text, "Sim");
                        MessageBox.Show("Funcionário inserido com sucesso", "Inserir Funcionário", MessageBoxButtons.OK);
                    }
                    catch (Exception ex)
                    {
        ...
        private void Funcionarios_Registar_Load(object sender, EventArgs e)
        {
        ...
        private void Funcionarios_Registar_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            if ((DateTime.Now.Year - datanasc.Year) >= 16)
            {
                dn = true;
                errorProvider10.SetError(dateTimePicker1, null);
            }
            ...
            {
                errorProvider10.SetError(dateTimePicker1, "Introduza uma data de nascimento superior a 15 anos");
            }
        }
